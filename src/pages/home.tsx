  ...
  return (
    <div className="relative flex items-center justify-center min-h-[360px]">
      ...
      <motion.div
        ...
        style={{ backdropFilter: "blur(16px)", background: "rgba(255,255,255,0.78)" }}
        {...float(1)}
      >
        <CheckCircle className="w-4 h-4 text-green-500" />
        <div className="text-sm font-bold text-foreground tracking-tight">Resilience</div>
        <div className="text-[10px] text-muted-foreground">회복력 · 복습 완료</div>
      </motion.div>
      ...
      >
        ...
        <div className="text-xs font-semibold text-foreground">오늘 4 / 5 완료</div>
        <div className="text-[10px] text-muted-foreground">연속 7일 학습 중</div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="text-3xl font-bold text-foreground tracking-tight">Serendipity</span>
...
export default function Home() {
  ...
  const fadeUp = (delay = 0): Variants => ({
    ...
    visible: {
      opacity: 1,
      y: 0,
      transition: { duration: shouldReduce ? 0 : 0.55, delay: shouldReduce ? 0 : delay, ease: "easeOut" },
    },
  });

  const stagger: Variants = {
    hidden: {},
    visible: { transition: { staggerChildren: shouldReduce ? 0 : 0.1, delayChildren: shouldReduce ? 0 : 0.1 } },
  };
    ...
    <div className="min-h-screen">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeUp(0.1)}
            >
              플래시카드를 만들고, 친구와 함께 편집하고,
              원하는 방식으로 학습하세요.
              FlipNote와 함께라면 공부가 달라집니다.
            </motion.p>

            <motion.div className="flex flex-wrap gap-3 pt-1" variants={fadeUp(0.15)}>
            ...
            <motion.div className="flex flex-wrap items-center gap-5" variants={fadeUp(0.2)}>
      ...
      <section className="py-24">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold tracking-tight mb-3">FlipNote의 모든 것</h2>
          <p className="text-muted-foreground text-lg">효율적인 학습을 위한 모든 기능이 담겨 있어요</p>
        </motion.div>

        {/* Bento Grid: 4-col, Apple-style */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4" style={{ gridAutoRows: "minmax(0, auto)" }}>
          ...
          >
            ...
            <h3 className="text-xl font-bold tracking-tight mb-2">스마트 학습 모드</h3>
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              연습, 암기, 시험 세 가지 모드로 자신에게 맞는 방식을 골라 학습하세요.
            </p>
            <div className="space-y-2.5">
              {[
                { label: "연습하기", desc: "자유롭게 카드 넘기기", selected: false },
                { label: "암기하기", desc: "간격 반복 학습법 적용", selected: true },
                { label: "시험 보기", desc: "실전 테스트 모드", selected: false },
              ].map((m) => (
                <div
                  key={m.label}
                  ...
                  <div>
                    ...
                    <div
                      className={`text-[11px] mt-0.5 ${
                        m.selected ? "text-primary-foreground/65" : "text-muted-foreground/70"
                      }`}
                    >
                      {m.desc}
                    </div>
          ...
          <motion.div
            ...
            initial={shouldReduce ? {} : { opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: shouldReduce ? 0 : 0.07, ease: "easeOut" }}
            viewport={{ once: true, margin: "-40px" }}
          >
            ...
            <h3 className="text-lg font-bold tracking-tight mb-1.5">실시간 협업 편집</h3>
            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
              최대 6명이 동시에 하나의 카드셋을 만들고 편집합니다.
            </p>
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2.5">
                {(["#6366f1", "#f59e0b", "#10b981", "#ef4444"] as const).map((color, i) => (
                  <div
                    key={i}
              ...
              <span className="text-sm text-muted-foreground">4명 함께 편집 중</span>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            initial={shouldReduce ? {} : { opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: shouldReduce ? 0 : 0.12, ease: "easeOut" }}
            viewport={{ once: true, margin: "-40px" }}
          >
            ...
            <h3 className="text-base font-bold tracking-tight mb-1.5">오답노트</h3>
                ...
                <div key={stat.label}>
                  ...
                  <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                    <motion.div
                      ...
                      transition={{ duration: shouldReduce ? 0 : 0.9, ease: "easeOut", delay: 0.2 }}
                      viewport={{ once: true }}
                    />
                  </div>
                </div>
          ...
          <motion.div
            ...
            initial={shouldReduce ? {} : { opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: shouldReduce ? 0 : 0.17, ease: "easeOut" }}
            viewport={{ once: true, margin: "-40px" }}
          >
            ...
            <div className="flex items-end gap-1 h-10">
              {[40, 65, 50, 80, 60, 90, 75].map((h, i) => (
                <motion.div
                  ...
                  transition={{ duration: shouldReduce ? 0 : 0.5, delay: i * 0.06, ease: "easeOut" }}
                  viewport={{ once: true }}
                />
              ))}
            </div>
          ...
          <motion.div
            ...
            initial={shouldReduce ? {} : { opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: shouldReduce ? 0 : 0.08, ease: "easeOut" }}
            viewport={{ once: true, margin: "-40px" }}
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold tracking-tight mb-1">그룹 학습 & 공유</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    그룹을 만들어 카드셋을 공유하고 함께 성장하는 학습 커뮤니티를 경험하세요.
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 border-t border-gray-100">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold tracking-tight mb-3">시작하는 방법</h2>
          <p className="text-muted-foreground text-lg">3단계로 바로 시작할 수 있어요</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            ...
            <motion.div
              ...
              initial={shouldReduce ? {} : { opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: shouldReduce ? 0 : i * 0.1, duration: 0.5, ease: "easeOut" }}
              viewport={{ once: true }}
            >
      ...
      <footer className="border-t border-gray-100 py-8">
        <div className="flex justify-between items-center flex-col sm:flex-row gap-4">
          ...
          <p className="text-sm text-muted-foreground">© 2025 FlipNote. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
